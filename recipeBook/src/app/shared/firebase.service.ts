...
export class firebaseService {
  ...
  postListIngredients() {
    ...
    this.http.put(
      'https://recipebook2020-f59f3.firebaseio.com/ingredients.json', ingredients
    ).subscribe();
  }
  // setIngredients
  fetchListIngredients() {
  return this.http.get<Ingredient[]>(
    'https://recipebook2020-f59f3.firebaseio.com/ingredients.json'
  ).pipe(
    tap(ingredients => {
  ...
  postLikes() {
    ...
    this.http.put('https://recipebook2020-f59f3.firebaseio.com/likes.json', counter).subscribe();
  }

  fetchLikes(){
    return this.http.get<number>('https://recipebook2020-f59f3.firebaseio.com/likes.json')
                    .pipe(tap(num => {
